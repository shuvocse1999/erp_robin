...
@section('content')
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="container">
            <form id="createForm" action="{{ route('vorlagen.antworten.update',$answersheet->id) }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="{{ $answersheet->id }}">
                <div class="row">
                    <div class="col-6 col-sm-6 col-md-6 col-lg-8 col-xl-8 mb-2">
                        <input class="form-control fontSize" id="titel" name="title" value="{{ $answersheet->title }}"
                                ...
                                <div data-repeater-item>
                                    <div class="form-group row">
                                        <div class="col-md-6 col-sm-12 mb-2">
                                            <input type="text" class="form-control mb-2 mb-md-0" name="answer" value="{{ $answer->answer }}" placeholder="Enter antwort"/>
                                        </div>
