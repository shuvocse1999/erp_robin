...
@section('content')
    ...
    <div class="stepper stepper-pills" id="kt_stepper_example_clickable">
        ...
        <!--begin::Form-->
        <form class="form w-lg-500px mx-auto" method="post" action="{{ url("current_danger") }}" novalidate="novalidate" id="kt_stepper_example_basic_form">
            ...
            <div class="mb-5">
                <div class="flex-column current" data-kt-stepper-element="content">
                    <div class="fv-row mb-10 row">
                        <div class="col-6">
                            <label class="form-check-image step-1-label">
                                <div class="form-check-wrapper">
                                    <img src="{{asset('public/assets')}}/media/stock/option1.png"/>
                                </div>

                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input step-1" type="checkbox" checked="" value="Maschinen und Analagen" name="options"/>
                                    <div class="form-check-label">
                                        Maschinen und Analagen
                                    </div>
                                </div>
                            </label>
                        </div>
                        <div class="col-6">
                            <label class="form-check-image step-1-label">
                                <div class="form-check-wrapper">
                                    <img src="{{asset('public/assets')}}/media/stock/option2.png"/>
                                </div>

                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input step-1" type="checkbox" value="Arbeits-platz" name="options"/>
                                    <div class="form-check-label">
                                        Arbeits-platz
                                    </div>
                                </div>
                        ...
                        <div class="col-6">
                            <label class="form-check-image step-1-label">
                                <div class="form-check-wrapper">
                                    <img src="{{asset('public/assets')}}/media/stock/option3.png"/>
                                </div>

                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input step-1" type="checkbox" value="Tatigkeiten" name="options"/>
                                    <div class="form-check-label">
                                        Tatigkeiten
                                    </div>
                                </div>
                        ...
                        <div class="col-6">
                            <label class="form-check-image step-1-label">
                                <div class="form-check-wrapper">
                                    <img src="{{asset('public/assets')}}/media/stock/option4.png"/>
                                </div>

                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input step-1" type="checkbox" value="Arbeits-/Betriebsmittel" name="options"/>
                                    <div class="form-check-label">
                ...
                <div class="flex-column" data-kt-stepper-element="content">
                    ...
                    <div class="fv-row mb-10 row">
                            <div class="col-6">
                                <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column me-5 mb-3 mb-md-0 fs-6 min-w-lg-200px  step-3">
                                </ul>
                            </div>
                            <div class="tab-content col-6" id="myTabContent">
                                @foreach($category as $cat)
                                <div class="tab-pane fade show active" id="kt_vtab_pane_{{$cat->id}}" role="tabpanel">
                                    @foreach($cat->categoryoption as $option)
                                    <label class="form-check-image step-3-input-label">
                                        <div class="form-check form-check-custom form-check-solid">
                                            <input class="form-check-input step-3-input" type="checkbox" value="1"
                                                   name="option2"/>
                                            <div><span>{{ $option->kat1 }}</span></div>
                                        </div>
                                    </label>
