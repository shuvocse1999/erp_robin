            ...
            <form id="kt_docs_formvalidation_text" class="form" method="POST"
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            @if(isset($user->avatar))
                                    <div class="image-input-wrapper w-125px h-125px"
                                         style="background-image: url('{{ asset('public/avatars/' . $user->avatar) }}')"></div>
                            @else
                                <div class="image-input-wrapper w-125px h-125px"
                ...
                <div class="fv-row mb-10">
                    ...
                    <select class="form-control form-control-solid mb-3 mb-lg-0" name="role" data-control="select2" data-placeholder="Select an option">
                        <option></option>
                        <option value="1" {{ $user->role_id == 1 ? 'selected':'' }}>Benutzer</option>
                        <option value="2" {{ $user->role_id == 2 ? 'selected':'' }}>Kunde</option>
