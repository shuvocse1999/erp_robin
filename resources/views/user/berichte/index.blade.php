        ...
        <div class="card-p-0 card-flush">
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                <div class="card-title">
                    <!--begin::Search-->
                    <div>
                        <h3 style="color: #2B6123">Bereichte</h3>
                    </div>
                    <!--end::Search-->
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    <form action="{{url()->current()}}" method="GET">
                        <div class="d-flex align-items-center position-relative my-1">
                            <input type="text" style="border-radius: 5px 0 0 5px" data-kt-filter="search" name="search" value="{{$search??''}}" class="form-control form-control-solid w-200px ps-5" placeholder="Suche" />
                ...
                {{-- @csrf--}}
                {{-- <select name="export_type" class="form-select form-select-solid"--}}
                {{-- data-control="select2" data-placeholder="Generate Pdf"--}}
                {{-- onchange="submitForm()">--}}
                {{-- <option></option>--}}
                ...
                <table class="table align-middle border rounded table-row-dashed fs-6 g-5 table-bordered table-responsive" style="padding: 0 5px">
                    ...
                    <tbody class="fw-semibold text-gray-600 text-center">
                        ...
                        <tr class="odd">
                            ...
                            {{-- <td><span class="text-dark">{{@$ansSubmission->userId->vorname}} {{@$ansSubmission->userId->nachname}}</span></td>--}}
...
{{--                                    <div class="text-dark">--}}
{{--                                        <a href="{{ route('formular.submission.view',['id' => $ansSubmission->id, 'user_id' => $ansSubmission->userId->id]) }}" class="btn btn-sm"><i class="fa fa-eye"></i></a>--}}
{{--                                    </div>--}}
{{--                                    <form action="{{ route('view-generate-pdf', $ansSubmission->id) }}" method="POST">--}}
{{--                                        @csrf--}}
{{--                                        <div class="text-dark">--}}
...
{{--                                    </form>--}}
{{--                                    <div class="text-dark">--}}
{{--                                        <a href="{{route('formular.submission.destroy',$ansSubmission->id)}}" class="btn btn-sm"><i class="fa fa-trash"></i></a>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </td>--}}
                        </tr>
