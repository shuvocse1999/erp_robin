                ...
                <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                            ...
                            <form action="{{ route('reset.password.post') }}" method="POST">
                                ...
                                <div class="form-group row mb-2">
                                    <label for="email_address" class="col-12 col-md-4 col-sm-4 col-lg-4 col-xl-4 col-form-label text-md-right">E-Mail Address</label>
                                ...
                                <div class="form-group row mb-2">
                                    <label for="password" class="col-12 col-md-4 col-sm-4 col-lg-4 col-xl-4 col-form-label text-md-right">Password</label>
                                    <div class="col-12 col-md-8 col-sm-8 col-lg-8 col-xl-8">
                                ...
                                <div class="form-group row mb-2">
                                    <label for="password-confirm" class="col-12 col-md-4 col-sm-4 col-lg-4 col-xl-4 col-form-label text-md-right">Confirm Password</label>
                                    <div class="col-12 col-md-8 col-sm-8 col-lg-8 col-xl-8">
                                        <input type="password" id="password-confirm" class="form-control" name="password_confirmation" required autofocus>
                                        <span class="text-danger">One capital & small letter, one special character. Minimum 8 character. Format: [Aa@12345]</span>
