...
<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
    ...
    <div class="d-flex flex-stack flex-grow-1">
        ...
        <div style="background-color: #000" class="header_img d-none">
            <a href="{{ route('user.dashboard') }}" class="app-sidebar-logo text-center">
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                ...
                <div
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                <div
                                    class="fw-bold d-flex align-items-center fs-5">{{ @\Illuminate\Support\Facades\Auth::user()->name }}
                                </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{ route('user.profile') }}" class="menu-link px-5">Mein Profil</a>
                    </div>
                    <div class="separator my-2"></div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
